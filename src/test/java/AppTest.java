...
//        webInteractions.clickByText("Forms");
//        webInteractions.navigateBrowser(backwards);
//        Assert.assertEquals("webInteractions.navigateBrowser(backwards) test failed!", baseUrl, driver.getCurrentUrl());
...
//
//    @Test
//    public void verifyAttributePresentTest() {
...
//
//    @Test
//    public void verifyAttributePresentTestNegative() {
//        log.info("Testing negative verifyAttributePresentText()");
//        webInteractions.getUrl(baseUrl);
//        try {
//            WebElement element = acquire.acquireListedElementFromPage("Forms", "toolCards", "pageClass");
