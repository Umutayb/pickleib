    ...
    enum DriverType {
        ...
        public static DriverType getParentType(Platform platform) {
            return switch (platform) {
                case WINDOWS, LINUX, UNIX, SONOMA, VENTURA, MONTEREY, BIG_SUR, CATALINA, MOJAVE, HIGH_SIERRA, SIERRA, EL_CAPITAN, YOSEMITE, MAVERICKS, MOUNTAIN_LION, SNOW_LEOPARD, MAC, WIN11, WIN10, WIN8_1, WIN8, WIN7, VISTA, XP -> Web;
