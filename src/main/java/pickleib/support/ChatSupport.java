...
public class ChatSupport {
    ...
    public static void main(String[] args) {
        try {
            GPT gpt = new GPT("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");
            Caller.keepLogs(false);

            String readme = new String(Files.readAllBytes(Paths.get("README.md")));

            String prompts = "Consider yourself who is considering PickleMaster. " +
            ...
            SupportGUI gui = new SupportGUI(List.of(prompts), "gpt-4", 0.7, gpt, "User", "Pickleib", "Pickleib Support");
            gui.start();
        }
